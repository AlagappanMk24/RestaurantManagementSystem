...
namespace Restaurants.Application.Restaurants.Dtos
{
    public class RestaurantsProfile : Profile
    {
        ...
        {
            CreateMap<Restaurant.Domain.Entities.RestaurantEntity, RestaurantDto>()
           ...
           .ForMember(d => d.Street, opt =>
            ...
            CreateMap<UpdateRestaurantCommand, Restaurant.Domain.Entities.RestaurantEntity>();

            CreateMap<CreateRestaurantCommand, Restaurant.Domain.Entities.RestaurantEntity>()
            ...
            CreateMap<Restaurant.Domain.Entities.RestaurantEntity, RestaurantStatisticsDto>()
