...
namespace Restaurant.Application.Features.Ratings.Commands.CreateRating;
...
public class CreateRatingCommandHandler(ILogger<CreateRatingCommandHandler> logger,
    ...
    IRestaurantRepository restaurantsRepository, ICustomerRepository customersRepository) : IRequestHandler<CreateRatingCommand, int>
{
